...
export const Section4: React.FC<{ resaurant: Restaurant }> = (props) => {
  ...
  let noOfComments = 0;
  let noOfVotes = 0;
  const noOfVotesAndComments = `${noOfComments} Votes for helpful , ${noOfVotes} Comments`;
              ...
              {props.resaurant.reviews.map((review, index) => {
                ...
                return (
                  <div className={classes.reviewContainer} key={index}>
                      ...
                      <div className={classes.ratingMain}>
                        <div className={classes.ratingHolder}>
                          <div className={classes.ratingHolderPrimary}>
                            <div className={classes.ratingHolderPrimaryContent}>
                    ...
                    <p className={classes.customerReview}>{review.text}</p>
                    {/* Customer review end */}
